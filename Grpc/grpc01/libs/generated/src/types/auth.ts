...
export interface User {
  ...
  age: number;
  subscribed: boolean;
  socailMedia: SocialMedia | undefined;
}
...
function createBaseUser(): User {
  return { id: "", username: "", password: "", age: 0, subscribed: false, socailMedia: undefined };
}
...
export const User: MessageFns<User> = {
  encode(message: User, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.socailMedia !== undefined) {
      SocialMedia.encode(message.socailMedia, writer.uint32(50).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.socailMedia = SocialMedia.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const SocialMedia: MessageFns<SocialMedia> = {
  encode(message: SocialMedia, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.linkedInUri !== undefined) {
      writer.uint32(10).string(message.linkedInUri);
    }
    if (message.facebookUri !== undefined) {
      writer.uint32(18).string(message.facebookUri);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1: {
          ...
          message.linkedInUri = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.facebookUri = reader.string();
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
...
export const UserServiceService = {
  createUser: {
    path: "/auth.UserService/CreateUser",
    requestStream: false,
  ...
  findAllUsers: {
    path: "/auth.UserService/FindAllUsers",
    requestStream: false,
    responseStream: false,
  ...
  findOneUser: {
    path: "/auth.UserService/FindOneUser",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FindOneUserDto): Buffer => Buffer.from(FindOneUserDto.encode(value).finish()),
    requestDeserialize: (value: Buffer): FindOneUserDto => FindOneUserDto.decode(value),
    responseSerialize: (value: User): Buffer => Buffer.from(User.encode(value).finish()),
    responseDeserialize: (value: Buffer): User => User.decode(value),
  },
  updateUser: {
    path: "/auth.UserService/UpdateUser",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: UpdateUserDto): Buffer => Buffer.from(UpdateUserDto.encode(value).finish()),
    requestDeserialize: (value: Buffer): UpdateUserDto => UpdateUserDto.decode(value),
    responseSerialize: (value: User): Buffer => Buffer.from(User.encode(value).finish()),
    responseDeserialize: (value: Buffer): User => User.decode(value),
  },
  removeUser: {
    path: "/auth.UserService/RemoveUser",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: FindOneUserDto): Buffer => Buffer.from(FindOneUserDto.encode(value).finish()),
    requestDeserialize: (value: Buffer): FindOneUserDto => FindOneUserDto.decode(value),
  ...
  queryUser: {
    path: "/auth.UserService/QueryUser",
    requestStream: true,
    responseStream: true,
    requestSerialize: (value: PaginationDto): Buffer => Buffer.from(PaginationDto.encode(value).finish()),
    requestDeserialize: (value: Buffer): PaginationDto => PaginationDto.decode(value),
    responseSerialize: (value: Users): Buffer => Buffer.from(Users.encode(value).finish()),
    responseDeserialize: (value: Buffer): Users => Users.decode(value),
  },
} as const;
...
export interface UserServiceServer extends UntypedServiceImplementation {
  ...
  queryUser: handleBidiStreamingCall<PaginationDto, Users>;
}
